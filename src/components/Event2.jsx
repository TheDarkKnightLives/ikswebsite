...
import mughalImage from "../assets/maratha_war.jpg"; // Adjusted path for the image
import sikhandmaratha from "../assets/sikhandmaratha.jpeg";
import mughalVideo from "../videos/maratha_war.mp4"; // Import the video
import sikhAndMarathaVideo from '../videos/regional_empires.mp4';
